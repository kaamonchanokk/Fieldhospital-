...
<body>
<center><p class="a">ถอนเตียงโรงพยาบาล</p></center>
<br>
<div class="block-1">
<br><br>
...
<center><p><?php echo "$fieldhospitalbedList->Name_Fh รองรับผู้ป่วยสี$fieldhospitalbedList->C_Name จำนวน $fieldhospitalbedList->Max_Hb เตียง"; ?></p></center>
<br>
<form method="get" action="">

    <input type="hidden" name="controller" value="fieldhospitalbed" />
    <input type="hidden" name="ID_Hb" value="<?php echo $fieldhospitalbedList->ID_Hb; ?>" />
