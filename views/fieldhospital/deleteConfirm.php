...
<body>
<center><p class="a">ถอนโรงพยาบาลสนาม</p></center>
<br>
<div class="block-1">
<br><br>
...
<center><p><?php echo "$fieldhospitalList->ID_Fh $fieldhospitalList->Name_Fh"; ?></p></center>
<br>
<form method="get" action="">

    <input type="hidden" name="controller" value="fieldhospital" />
    <input type="hidden" name="ID_Fh" value="<?php echo $fieldhospitalList->ID_Fh; ?>" />
