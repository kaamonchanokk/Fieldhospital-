...
<center><p class="a">บันทึกการรองรับผู้ป่วย</p></center>
<br>
<div class="block-1">
<br>
<br>
<div class="col-25"><label>วันที่</label></div><div class="col-75"><input type="date" name="Date_Sup"/></div><br><br><br>
<div class="col-25"><label>เวลา</label></div><div class="col-75"><input type="time" name="Time_Sup"/></div><br><br><br>
...
<?php foreach($fieldhospitalbedList as $hb) {echo "<option value = $hb->ID_Hb>
    $hb->Name_Fh เตียงสี$hb->C_Name</option>";}?>
    </select></div><br><br><br>

<input type="hidden"name="controller"value="supportpatient"/>
<button class="buttonA" type= "submit"name="action"value="addSupportpatient">ลงทะเบียน</button>
